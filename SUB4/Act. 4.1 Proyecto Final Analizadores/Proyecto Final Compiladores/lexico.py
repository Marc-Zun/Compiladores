...
class LexerApp:
    def __init__(self):
        ...
        self.windows.configure(bg="#F5E8C7")

        #Crea una etiqueta para el titulo de la aplicacion
        self.text_label = tk.Label(text="----- ANALIZADOR LÉXICO -----", height=1, width=41, font=("Arial", 20, 'bold'), fg="#FFF3DA", bg="#141E46")
        self.text_label.pack()
        
        # Crea una etiqueta para el ingreso del código
        self.text_label_input = tk.Label(text="Ingrese el código:", height=1, width=20, font=("Arial", 14,),  bg="#F5E8C7")
        ...
        self.button_frame = tk.Frame(self.windows, bg="#F5E8C7")
        ...
        self.text_label = tk.Label(text=" ---- Contador de Elementos --- ", height=1, width=50, font=("Arial", 15, 'bold'), fg="#141E46", bg="#F5E8C7")
        ...
        self.regresar_button = tk.Button(self.windows, text="Regresar al menú", command=self.regresar, font=("Arial", 16, 'bold'), bg="#61A3BA")
        self.regresar_button.pack(padx=5)
        
        self.vacio_frame = tk.Frame(self.windows, bg="#F5E8C7")
        self.vacio_frame.pack(pady=5)
